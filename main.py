...
if __name__ == '__main__':
    ...
    parser.add_argument("--model", type=str, choices=["s1-32B", "DeepSeek-R1-Distill-Qwen-1.5B", "s1.1-3B"], default="s1.1-3B")
    ...
    forcefull(inference, dataset, args.partial, args.batch_size, 10000)
